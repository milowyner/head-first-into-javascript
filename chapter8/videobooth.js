...
function getFormatExtension() {
  if (video.canPlayType("video/mp4") != "") {
    ...
    console.log("ERROR: Can't find format extension");
  }
}
...
//function videoEffect(effect) {
//  create canvas element the same size as video
//  turn video into pixels on canvas
//  if (effect == "normal") {
//    delete canvas
//  } else if (effect == "western") {
//    make canvas warmer
//  } else if (effect == "noir") {
//    make canvas grayscale
//  } else if (effect == "scifi") {
//    make canvas inverted
//  }
//}
